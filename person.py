...
persons = {
    ...
    PersonEnum.MON_SPIDER_HUNTSMAN:
        Mob(PersonEnum.MON_SPIDER_HUNTSMAN, "a large huntsman spider",
            ...
            mob_skills={
                SkillEnum.AWARENESS: 70,
                SkillEnum.STEALTH: 50,
            },
            mob_attacks=[
